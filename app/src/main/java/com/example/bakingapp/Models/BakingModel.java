...
public class BakingModel implements Parcelable
{
    ...
    public final static Parcelable.Creator<BakingModel> CREATOR = new Creator<BakingModel>() {
     ...
     * @param steps
     */
    public BakingModel(Integer id, String name, List<Ingredient> ingredients, List<Step> steps, Integer servings, String image) {
        super();
        this.id = id;
        this.name = name;
